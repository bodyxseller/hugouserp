<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('manufacturing.boms.create') }}" class="erp-btn erp-btn-primary">
                        ...
                        <tr wire:key="bom-{{ $bom->id }}">
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('manufacturing.boms.edit', $bom) }}" class="text-emerald-600 hover:text-emerald-900" title="{{ __('Edit') }}">
