<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('manufacturing.production-orders.create') }}" class="erp-btn erp-btn-primary">
                        ...
                        <tr wire:key="order-{{ $order->id }}">
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('manufacturing.production-orders.show', $order) }}" class="text-slate-600 hover:text-slate-900" title="{{ __('View') }}">
